  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between h-9">
        ...
        {/* Right: attach btn + voice btn + screen capture btn + send btn */}
        <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`flex items-center justify-center w-8 h-8 rounded-lg transition-colors ${
                isRecordingVoice
                  ...
                  : 'text-muted-dim hover:text-muted hover:bg-sidebar-accent'
              }`}
          ...
          {onScreenCapture && (
            ...
            >
              <span className="material-icon" style={{ fontSize: 20 }}>screenshot</span>
            </button>
          )}
          {isLoading ? (
            <button
